...
pug_html = pug_html + "\u003Chtml\u003E\u003Chead\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv ld=\"root\"\u003E\u003C\u002Fdiv\u003E";
pug_mixins["script"]([
      {name: "proxise"},
...
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Evar view,mgr;view=new ldview({root:document.body});mgr=new block.manager({registry:function(r){var e,n,t,o;e=r.url,n=r.name,t=r.path;if(o=e){return o}return\"\u002Fblock\u002F\"+n+\"\u002F\"+(t||\"index.html\")}});mgr.init().then(function(){return mgr.from({name:\"sample\"},{root:view.get(\"root\")})}).then(function(r){return console.log(r)});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
